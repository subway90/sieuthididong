                                ...
                                <div class="col">
                                    <nav class="mb-2" aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-sa-simple">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Quản lí loại tin tức</li>
                                        </ol>
                                    </nav>
                                </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <li><a class="dropdown-item" href="<?=ACT_ADMIN?>news-category-add&edit=<?=$id?>">Chỉnh sửa</a></li>
                                                    <li><hr class="dropdown-divider"/></li>
                                                    <?php
                                                    if($status == 1){ ?>
                                                    <li><a class="dropdown-item text-danger" href="<?=ACT_ADMIN?>news-category&delete=2&id=<?=$id?>">Ẩn loại</a></li>
                                                    <?php }else{ ?>
                                                    <li><a class="dropdown-item text-success" href="<?=ACT_ADMIN?>news-category&delete=1&id=<?=$id?>">Hiện loại</a></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        </td>
