...
<form action="<?=ACT_ADMIN?>category-add&add" method="post" enctype="multipart/form-data">
                                    ...
                                    <nav class="mb-2" aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-sa-simple">
                                            ...
                                            <li class="breadcrumb-item"><a
                                                    href="<?=ACT_ADMIN?>category">Quản lí danh mục</a></li>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-5 row">
                                            <div class="col-12 mb-5">
                                                <h2 class="mb-0 fs-exact-18">Nhập thông tin danh mục</h2>
                                            </div>
                                            <div class="col-6 form-floating mb-2 p-0 px-3">
                                                <input name="ten_danhmuc" value="<?=$ten_danhmuc?>" type="text" class="form-control rounded rounded-5" id="floatingInput" placeholder="name@example.com">
