...
<form action="<?=ACT_ADMIN?>news-category-add<?=$subURL?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <nav class="mb-2" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-sa-simple">
                                ...
                                <li class="breadcrumb-item"><a href="<?=ACT_ADMIN?>news-category">Quản lí loại tin</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Thêm loại tin</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-auto d-flex"><a href="<?=ACT_ADMIN?>news-category" class="btn btn-secondary me-3">Hủy</a>
