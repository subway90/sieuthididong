...
<form action="<?=ACT_ADMIN?>publishing-edit&id=<?=$_GET['id']?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <nav class="mb-2" aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-sa-simple">
                                            ...
                                            <li class="breadcrumb-item"><a
                                                    href="<?=ACT_ADMIN?>publishing">Quản lí nhà xuất bản</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Sửa nhà xuất bản</li>
                                        </ol>
                                    </nav>
                                    <h1 class="h3 m-0">Thêm nhà xuất bản</h1>
                                </div>
                                <div class="col-auto d-flex"><a href="<?=ACT_ADMIN?>publishing" class="btn btn-secondary me-3">Hủy</a>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-5 row">
                                            <div class="col-12 mb-5">
                                                <h2 class="mb-0 fs-exact-18">Nhập thông tin NXB</h2>
                                            </div>
                                            <div class="col-6 form-floating mb-2 p-0 px-3">
                                                ...
                                                <label for="floatingInput">Tên nhà xuất bản</label>
                                            </div>
                                            <div class="col-6 form-floating mb-2 p-0 px-3">
