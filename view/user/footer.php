        ...
        <div class="col-12 col-md-3 col-lg-3">
            ...
            <div class="row">
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-atm.png" alt="">
                </div>
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-jcb.png" alt="">
                </div>
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-master.png" alt="">
                </div>
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-samsungpay.png" alt="">
                </div>
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-visa.png" alt="">
                </div>
                <div class="col-3 col-md-3 col-lg-3 text-center py-2">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-tranfer-online/logo-vnpay.png" alt="">
                </div>
            </div>
            <p class="h5 text-light mt-3">Nhà vận chuyển</p>
            <div class="row">
                <div class="col-3">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-transport/nhattin.jpg" alt="">
                </div>
                <div class="col-3">
                    <img class="w-100" src="<?= URL ?>publics/img/system/icon-transport/vnpost.jpg" alt="">
                </div>
            </div>
            <p class="h5 text-light mt-3">Giấy phép</p>
            <div>
                <img class="w-50" src="<?= URL ?>publics/img/system/logo-bct.png" height="40px" alt="">
            </div>
        </div>
