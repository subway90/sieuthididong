    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="4000">
            <img src="/publics/img/carousel/a55.jpg" class="d-block w-100" alt="a55.jpg">
          </div>
          <div class="carousel-item" data-bs-interval="4000">
            <img src="/publics/img/carousel/acer-3-01.png" class="d-block w-100" alt="acer-3-01.png">
          </div>
          <div class="carousel-item" data-bs-interval="4000">
            <img src="/publics/img/carousel/digital-freeclip-web.jpg" class="d-block w-100" alt="digital-freeclip-web.jpg">
          </div>
        </div>
    ...
    <div class="row mt-2">
        <div class="col-6 col-md-3 col-lg-3 py-2">
            <div class="card border-0">
                <img src="publics/img/box-index/8c5m4pa.png" alt="">
            </div>
        </div>
        <div class="col-6 col-md-3 col-lg-3 py-2">
            <div class="card border-0">
                <img src="publics/img/box-index/s23-ultra-63.png" alt="">
            </div>
        </div>
        <div class="col-6 col-md-3 col-lg-3 py-2">
            <div class="card border-0">
                <img src="publics/img/box-index/thu-cu_638466130644683857.png" alt="">
            </div>
        </div>
        <div class="col-6 col-md-3 col-lg-3 py-2">
            <div class="card border-0">
                <img src="publics/img/box-index/xiaomi-watch-2.png" alt="">
            </div>
        </div>
    </div>
    <?php if(FLASH_SALE) { 
                                ...
                                <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
                                    <div style="min-height:100%" class="card shadow">
                                        <div class="position-relative hover-trigger">
                                            <img src="publics/img/phone/samsung/a34-3.jpg" class="card-img img-product" alt="...">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
                                    <div style="min-height:100%" class="card shadow">
                                        <div class="position-relative hover-trigger">
                                            <img src="publics/img/phone/redmi/note12.jpg" class="card-img img-product" alt="...">
                                            <span style="left: 84%; top: -4%; width: 45px; height: 45px" class="btn bg-danger text-light rounded-circle position-absolute small p-0 pt-2 fw-bold ">22%</span>
                                            <span class="show-hover position-absolute end-0 bottom-0 w-100">
                                                <div class="d-flex justify-content-evenly">
                                                    <button class="btn btn-success">
                                                        <i class="far fa-heart"></i>
                                        ...
                                        <a class="text-decoration-none" href="#!/chi-tiet/1">
                                            <div class="card-body">
                                                <h5 class="card-title fs-6 fw-bold text-dark">Redmi Note 12 4GB /128GB</h5>
                                                <p class="card-text">
                                                    <span class="text-danger fw-bold me-1">3,880,000 đ</span>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
            <div style="min-height: 100%;" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/phone/iphone/iphone-12/origin/12-green.jpg" class="card-img img-product" alt="...">
                    <span style="left: 84%; top: -4%; width: 45px; height: 45px" class="btn bg-danger text-light rounded-circle position-absolute small p-0 pt-2 fw-bold ">51%</span>
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
            <div style="min-height: 100%;" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/phone/iphone/iphone-13/mini/13-mini-blue-pure.jpg" class="card-img img-product" alt="...">
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
            <div style="min-height: 100%;" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/phone/iphone/iphone-14/origin/14-blue-pure.jpg" class="card-img img-product" alt="...">
                    <span style="left: 84%; top: -4%; width: 45px; height: 45px" class="btn bg-danger text-light rounded-circle position-absolute small p-0 pt-2 fw-bold ">47%</span>
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
            <div style="min-height: 100%;" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/phone/iphone/iphone-14/plus/14plus-purple.jpg" class="card-img img-product" alt="...">
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-3 pb-md-4 pb-lg-5">
            <div style="min-height: 100%;" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/phone/iphone/iphone-15/plus/iphone-15-plus-blue-pure.jpg" class="card-img img-product" alt="...">
...
<div class="container-fluid p-0  mt-5">
    <a href="#!/chi-tiet/1">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 ps-lg-3  p-md-0 ps-md-3">
                <img class="w-100" src="publics/img/ads/ads-pc2-1.png" alt="">
            </div>
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 pe-lg-3 p-md-0 pe-md-3">
                <img class="w-100" src="publics/img/ads/ads-pc2-2.png" alt="">
            </div>
        </div>
    </a>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/acer/nitro-5-an515.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/asus/expert-book-k1at5f.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/asus/tuf-gaming-f15.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/dell/inspiron-15-3520.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/hp/gaming-vitus-15.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
        ...
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/laptop/lenovo/ideapad-1-a5tf7.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
...
<div class="container-fluid p-0  mt-5">
    <a href="#!/chi-tiet/1">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 ps-lg-3  p-md-0 ps-md-3">
                <img class="w-100" src="publics/img/ads/free-clip-1.jpg" alt="">
            </div>
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 pe-lg-3 p-md-0 pe-md-3">
                <img class="w-100" src="publics/img/ads/free-clip-2.jpg" alt="">
            </div>
        </div>
    </a>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-6 col-md-4 col-lg-2 pb-1 pb-md-2 pb-lg-2">
            <div style="min-height:100%" class="card shadow">
                <div class="position-relative hover-trigger">
                    <img src="publics/img/accesories/huawei/freeclip-huawei.jpg" class="card-img" alt="...">
                    <span class="show-hover position-absolute end-0 bottom-0 w-100">
                        <div class="d-flex justify-content-evenly">
                            <button class="btn btn-success">
                                <i class="far fa-heart"></i>
...
<div class="container-fluid p-0  mt-5">
    <a href="#!/chi-tiet/1">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 ps-lg-3  p-md-0 ps-md-3">
                <img class="w-100" src="publics/img/ads/ads-pc-1-1.png" alt="">
            </div>
            <div class="col-12 col-md-6 col-lg-6 p-lg-0 pe-lg-3 p-md-0 pe-md-3">
                <img class="w-100" src="publics/img/ads/ads-pc-1-2.png" alt="">
            </div>
        </div>
    </a>
</div>
        ...
        <div class="carousel-inner">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/samsung-galaxy-s23-ultra-camera-bump.jpg" class="card-img" height="200px;" alt="...">
                ...
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/a55-thumb.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
                ...
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/ASUS-2-2048x1538.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
          ...
          <div class="carousel-item">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/dung-ipad-hoc-tap.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
                ...
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/oscal-brand-logo-news.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
                ...
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/kv-new-1.jpeg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
          ...
          <div class="carousel-item">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/vi-xu-ly-galaxy-s25-1.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
                ...
                <div class="col-12 col-md-6 col-lg-4 pb-3 pb-md-2 pb-lg-0">
                    <div class="card hover-trigger position-relative">
                        <img src="/publics/img/news/vivo-x-book-3.jpg" class="card-img" height="200px;" alt="...">
                        <span class="position-absolute bottom-0 text-light fw-bold fs-6 px-2 pb-2 bg-success bg-opacity-50 text-start w-100">
